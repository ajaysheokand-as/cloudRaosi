...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
  <div class="container-fluid">
    <a href="index.php" class="navbar-brand border border-secondary rounded p-1">
      ...
      <span class="brand-text text-success font-weight-bold ">Spicy</span><span class="brand-text text-danger font-weight-bold ">Rasoi</span>
    </a>
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link border border-success rounded"><i class="fas fa-phone"> 7015393229</i></a>
        </li>
      </ul>
