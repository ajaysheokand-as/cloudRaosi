...
<?php require_once "../config.php"; ?>
  ...
  <body class="layout-top-nav control-sidebar-slide-open" style="height: auto;">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <h2 class="page-header">
                      <i class="fas fa-hotel"></i>Restaurant
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                To
                <address>
                  <strong><span id="customerName">
                   <input  id="invoice_customer_name" class="form-control no-border" /> 
          ...
          Email: john.doe@example.com -->
              ...
              <!-- /.col -->
              <div class="col-sm-4 invoice-col">
                <b>Bill No. : <span id="bill">
                  <?php //echo $row['bill_no']; ?>
                  <input  id="invoice_bill_no" class="form-control no-border" /> 
                ...
                <table class="table table-striped">
                  ...
                  <table class="table table-striped">
                    <tbody>
                      <tr id="invoice_list">
                      <td>
                          <input  type="number" id="invoice_cart_sr" value="1" class="form-control no-border" /> 
                        </td>
                        <td>
                          <input  id="invoice_product_name" class="form-control no-border" /> 
                        </td>
                        <td>
                          <input type="number" id="invoice_product_qty" oninput="calculateSubTotal()" class="form-control no-border" /> 
                        </td>
                        <td>
                          <input type="number"  id="invoice_product_price" oninput="calculateSubTotal()" class="form-control no-border" /> 
                        </td>
                        <td>
                          <input  id="invoice_product_subtotal" class="form-control no-border" /> 
                        </td>
                        <!-- <td><?php echo $i++; ?></td>
                    ...
                    <tr>
                      <td>
                        <button class="btn btn-primary" onclick="addItemToCartList()" >Add</button>
                      </td>
                      <td></td>
                      <td></td>
                      <td><b>Total</b></td>
    ...
    <script src="./scripts/customInvoice.js"></script>
  </body>
